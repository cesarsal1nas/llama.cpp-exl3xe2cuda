...
// optional: target samples for this verify batch (accepted drafts + bonus).
// Lets draft-mtp fuse process() catch-up with draft-0 when the target samples
// on the CPU after decode.
